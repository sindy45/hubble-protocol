...
const { addMargin } = require('../common')
...
async function main() {
    ...
    const { marginAccountHelper, clearingHouse } =  await setupContracts({
        governance,
        restrictedVUSD: false,
        genesisProxies: true,
        mockOrderBook: false,
        orderbookRollup: true,
    ...
    await clearingHouse.setValidatorStatus(ethers.utils.getAddress('0x4Cf2eD3665F6bFA95cE6A11CFDb7A2EF5FC1C7E4'), true)
